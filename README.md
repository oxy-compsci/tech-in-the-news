...
* [A new free app makes using iPads easier for people with hand tremors](https://www.theverge.com/2022/4/13/23024029/staybl-ipads-hand-tremors-parkinsons-disease)
  ...
  Staybl is a new app that is designed to help people with hand tremors browse the internet easier. The iPad app was designed by the global advertising company Havas Creative because they wanted to improve technology access to people dealing with Parkinsons Disease and other tremor related diseases. The company believes that people always talk about how technology should improve our lives, but they don’t naturally include everyone in those benefits. That is why they came up with a technological solution to help more types of people browse the internet. Havas Creative managed to create a more accessible internet browser by using the iPad's accelerometer to detect which direction the iPad is shaken and it tilts the screen in the opposite direction in order to create a more stable display. Havas Creative has previously developed technology solutions to help people with similar disabilities. I personally am very much in support of companies like Havas Creative who are trying to make technology accessible and helpful to more people. Oftentimes technology is designed so that as long as the general population is able to use it, it is released as the final product. However, those at the margins are often left out of consideration  in the design of those products. Designing for those at the margins of society is why products like this one are so important. I also support that those who particpated in the design of the app consulted with experts from the German Parkinson’s Association and Parkinson’s patients in Germany and the US. I think this is important because this means that they were directly consulting with the people that the app was being designed for which I think helps make for a better more accesible app.
