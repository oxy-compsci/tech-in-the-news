...
* [3 Questions: How the MIT mini cheetah learns to run](https://news.mit.edu/2022/3-questions-how-mit-mini-cheetah-learns-run-fast-0317)
	...
	Researchers at MIT have broken the record for the fastest run by a robot. Their "mini cheetah" bot is trained via reinforcement learning. It has conquered the difficult challenge of being able to efficiently run on and adapt to different types of terrains. The researchers describe the advantages of using reinforcement learning in order to achieve this feat. Through learning by experience on different terrains, a human engineer no longer needs to identify the problem and manually adapt the robot. Instead, through simulation tools, the robot can gain "100 days'" worth of training in just three hours.


* [Wordle: New York Times changes upset fans](https://www.bbc.com/news/technology-60416057)

	At the end of January 2022, the New York Times bought out the popular emerging word game called "Wordle." One of the biggest complaints the game is currently facing is that the words to be solved have gotten harder. This has even garnered the attention of notable figures such as Trevor Noah. He tweeted "I thought @roywoodjr was just joking but it really feels like Wordle isn’t fun since the New York Times took over. Is it just me??" The New York Times denies that they have made changes to the game's difficulty; however, it was working to remove offensive words from its list of acceptable answers. Additionally, the New York Times has hinted at possibly making the game pay-to-play, which has also caused anger in fans of the game. As for now though, the game will remain free.