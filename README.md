...
* [Amazon to conduct racial equity audit led by former US attorney general](https://techcrunch.com/2022/04/19/netflix-to-charge-global-members-sharing-their-accounts-an-additional-fee-following-tests/)

  Amazon announces that it will be conducting racial equity audits to evaluate racial disparities of its policies for hourly employees. This audit will be led by former Attorney General Loretta Lynch. Amazon is doing this because shareholders pressured them to because of the controversies around the companies hiring practices and the treatment of warehouse workers. Even though Amazon is undergoing a racial equity audit, in their SEC filing, Amazon urged shareholders to vote against a separate proposal to also conduct a diversity and equity audit. They said this because they believed that doing this audit would be unnecessary because it would cover the same issue. Additionally, a spokesperson for DiNapoli's office expressed some concern that Amazon has revealed very little details about the audit and that they have made no assurances that the audit will be independent.  I am skeptical that this audit will make any meaningful changes. It seems like Amazon is doing this audit because they just want the the public to know that they have had an audit for racial equity at the company. I think they are doing this to put people who have been complaining about racial discriminatory issues  issues at ease.  It seems like they are not making efforts to actually find problems and solutions for racial equity and diversity issues they many have.  I think this is especially true because of the lack of details of the audit and the shareholders not wanting additional audits that have to do with racial diversity.  
